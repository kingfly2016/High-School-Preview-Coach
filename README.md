...
推荐让学生从“开始学习”进入，由 AI 一步一步推进：

```text
Use $high-school-preview-coach 开始学习
```
...
1. 选择科目：数学或英语。
2. 输入本节课主题和 3-5 句话复述。
3. AI 检查复述，必要时先追问 1 个问题。
4. AI 根据薄弱点出题，先不给答案。
5. 学生提交答案。
6. AI 批改、分类错因、给具体正反馈和同类变式题。
7. AI 生成可复制到学习记录表的错题记录和 3 天后复做提醒。

这样比一次性把所有材料都交给 AI 更适合学生使用，因为每一步都有明确动作，学生不容易跳过“复述”和“独立作答”。
